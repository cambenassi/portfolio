...
export default function AboutMe() {
  return (
    <>
      <div class="bg-neutral-300 mx-10 pb-10 rounded-b-2xl" id="aboutMeContainer">
        <h1 class="flex justify-center pt-[40px] text-6xl">About Me</h1>
        <div class="flex pt-[60px]" id="columnsWrapper">
          <div class="w-[50vw] ml-48" id="col1">
            <div role="status" class="">
              <div class="flex justify-center items-center w-96 h-60 bg-gray-300 rounded sm:w-96 dark:bg-gray-500">
